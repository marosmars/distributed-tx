...
public class DistributedTxModuleTest {
    ...
    public void testCustomValidation() {
        DistributedTxModule module = new DistributedTxModule(mock(ModuleIdentifier.class), mock(DependencyResolver.class));
    ...
    public void testCreateInstance() throws Exception {
        ...
        DistributedTxModule module = new DistributedTxModule(mock(ModuleIdentifier.class), dependencyResolver);
